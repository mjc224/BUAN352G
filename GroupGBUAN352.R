...
#plot(MSFT.2yr.ts)
plot(MSFT.2yr.ts, xaxt = "n", main = "MSFT Time Series (2 Years)")
...
#plot(AMZN.2yr.ts)
plot(AMZN.2yr.ts, xaxt = "n", main = "AMZN Time Series (2 Years)")
axis(1, at=c(1,2,3), labels=c("11/30/21","11/30/22","11/30/23"))
...
#plot(NVDA.2yr.ts)
plot(NVDA.2yr.ts, xaxt = "n", main = "NVDA Time Series (2 Years)")
axis(1, at=c(1,2,3), labels=c("11/30/21","11/30/22","11/30/23"))
...
#plot(AAPL.2yr.ts)
plot(AAPL.2yr.ts, xaxt = "n", main = "AAPL Time Series (2 Years)")
axis(1, at=c(1,2,3), labels=c("11/30/21","11/30/22","11/30/23"))
...
#plot(GOOG.2yr.ts)
plot(GOOG.2yr.ts, xaxt = "n", main = "GOOG Time Series (2 Years)")
axis(1, at=c(1,2,3), labels=c("11/30/21","11/30/22","11/30/23"))
...
#plot(TSLA.2yr.ts)
plot(TSLA.2yr.ts, xaxt = "n", main = "TSLA Time Series (2 Years)")
axis(1, at=c(1,2,3), labels=c("11/30/21","11/30/22","11/30/23"))
...
#plot(META.2yr.ts)
plot(META.2yr.ts, xaxt = "n", main = "META Time Series (2 Years)")
axis(1, at=c(1,2,3), labels=c("11/30/21","11/30/22","11/30/23"))
